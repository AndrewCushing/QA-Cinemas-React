...
class FilmDetails extends Component {
    ...
    componentDidMount() {
        // TODO: Hook up to API. This is hard-coded data!
        const movies = [
    ...
    render() {
        console.log(this.state.movie.poster_src)
        console.log(this.state.movie.classification_src)
return <Router><table className="navbar navbar-expand-md navbar-dark bg-secondary text-white" style ={{marginTop:50,marginBottom:100,padding:10}}>
        <tbody>
          <tr>
            <td>
